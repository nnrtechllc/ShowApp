...
struct RegisterView: View{
    ...
    var body: some View{
        VStack(spacing: 10){
                ...
                Text("Hello, please fill out the following")
                    .font(.title3)
                    .hAlign(.leading)
        ...
        @ViewBuilder
         func HelperView()->some View{
             ...
             TextField("Instagram Bio", text: $userBioLink)
                 .textContentType(.emailAddress)
                 .border(1, .gray.opacity(0.5))
    ...
    func registerUser(){
        ...
        Task{
            do{
                ...
                print("Not successfull  o")
                try await Auth.auth().createUser(withEmail: emailID, password: password)
                // Step 2: Uploading Profile Photo Into Firebase Storage
                print("Not successfull  oo")
                guard let userUID = Auth.auth().currentUser?.uid else{return}
                print("Not successfull  1")
                guard let imageData = userProfilePicData else{return}
                print("Not successfull  2")
